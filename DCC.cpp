...
void DCC::pomWriteAccessory(int cab, int cv, byte bValue) {
  byte b[5];
  int nB = 0;

  // Extract precise NMRA address bits from cab (0-indexed 11-bit address space)
  ...
  // Bit 3 = 1 (Programming device default write flag)
  // Bits 1-2 = a1a0
  // Bit 0 = 0
